...
input="./sample/blockpoa.json"
while IFS= read -r line
do
  newvariable=$(printf "%x" $timestamp)
  echo "${line/TIMESTAMP/0x$newvariable}" >> blockpoa.json
done < "$input"
echo "}\n" >> blockpoa.json
...
nohup geth --networkid 14333 \
     ...
     --mine \
     --miner.etherbase 0x6D9F2a4D1c7863B1eFB39781af62219AE4759596 &
